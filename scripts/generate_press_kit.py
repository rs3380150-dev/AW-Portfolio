...
def make_assets(frontend, work_dir):
    ...
    portrait_source = frontend / "public" / "assets" / "images" / "site" / "about-portrait.jpeg"
...
def main():
    ...
    frontend = args.frontend.resolve() if args.frontend else project_root / "frontend"
    ...
    if args.output is None:
        archive = project_root / "design-assets" / "exports" / "press-kit" / "achyut-wadhwa-press-kit.pdf"
